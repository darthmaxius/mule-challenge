...
import formatString2Elements from '../../helpers/format-string-to-elements';
import Button from '../../components/button';

function ButtonWrappered({ children, setElementsHandler, textAreaValue, className, setResumeHandler }) {
  ...
  return (
    <Button className={className} onClickHandler={insertText}>
      {children}
    </Button>
  );
}

export default ButtonWrappered;
